...
namespace mesh_processing {
    ...
    void MeshProcessing::add_isoline_segment(const std::pair<size_t, size_t> &borders01,
                                             const std::pair<size_t, size_t> &borders02,
    ...
    void MeshProcessing::compute_isolines(const std::vector<size_t> &constraint_indices, string property_name,
