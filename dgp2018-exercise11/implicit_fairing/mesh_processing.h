...
namespace mesh_processing {
    ...
    public:
        ...
        enum DEFORMATION_MODE {MINIMAL_SURFACE=0, THIN_PLATE=1};
        ...
        void set_selection(const Eigen::Vector3f &point, size_t edit_constraint_index) {
            selection_.col(edit_constraint_index) = point;
        }
        ...
        void deformation(DEFORMATION_MODE mode = THIN_PLATE, bool uniform = false);
