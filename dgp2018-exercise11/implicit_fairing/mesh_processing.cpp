...
namespace mesh_processing {
    ...
    bool ray_triangle_intersection(const Eigen::Vector3f &p0, const Eigen::Vector3f &p1, const Eigen::Vector3f &p2,
                                   const Eigen::Vector3f &o, const Eigen::Vector3f &d, Eigen::Vector3f &i) {
