...
As we at first only care about which area is smaller, we can calculate it on the unit sphere.
...
A handy thing for areas on surfaces is the First Fundemental Form
\begin{equation}
	\mathbf{I} =
	\begin{pmatrix}
		E & F\\
